...
if(!class_exists('NF5_Instalation'))
	...
	class NF5_Instalation{
		...
		public function run_instalation($type){	
				...
				$api_params = array( 'nexforms-installation' => 1, 'source' => 'codecanyon', 'email_address' => get_option('admin_email'), 'for_site' => get_option('siteurl'), 'get_option'=>(is_array(get_option('7103891'))) ? 1 : 0);
